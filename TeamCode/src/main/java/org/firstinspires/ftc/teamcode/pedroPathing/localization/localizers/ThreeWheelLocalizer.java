...
public class ThreeWheelLocalizer extends Localizer {
    ...
    public static double FORWARD_TICKS_TO_INCHES = 0.0019949289901091153;//8192 * 1.37795 * 2 * Math.PI * 0.5008239963;
    public static double STRAFE_TICKS_TO_INCHES = 0.002048233283908885;//8192 * 1.37795 * 2 * Math.PI * 0.5018874659;
    ...
    public ThreeWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        leftEncoderPose = new Pose(-6.868622047, 3.19311024, 0);
        rightEncoderPose = new Pose(-6.868622047, -3.0888189, 0);
        strafeEncoderPose = new Pose(-6.4, 0.22940945, Math.toRadians(90));

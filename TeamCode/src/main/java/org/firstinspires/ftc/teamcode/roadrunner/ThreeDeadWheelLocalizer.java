...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks =  -1498.651361510996; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1704.5774552276223; // y position of the second parallel encoder (in tick units)
        public double perpXTicks =  -3537.1652318754504; // x position of the perpendicular encoder (in tick units)
    }
